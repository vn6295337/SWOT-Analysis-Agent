  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground hidden sm:block">
                  Automated market intelligence with self-evaluating agents
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
      ...
      <main className="container mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        {(isLoading || showResults) && viewMode === 'full' && (
          <ProcessFlow
        ...
        {/* Activity Log - visible during execution in full view */}
        {isLoading && viewMode === 'full' && (
          <ActivityLog entries={activityLog} />
        )}

        {/* Loading State */}
        {isLoading && viewMode === 'executive' && (
          <Card className="flex flex-col items-center justify-center py-16 animate-fade-in">
            <RefreshCw className="h-8 w-8 text-primary animate-spin mb-4" />
            <h2 className="text-xl font-medium text-foreground mb-2">
              Analyzing {selectedStock?.name}
            </h2>
            <p className="text-muted-foreground">
              {currentStep === 'researcher' ? 'Gathering data...' :
               currentStep === 'analyzer' ? 'Synthesizing SWOT...' :
               currentStep === 'critic' ? 'Evaluating quality...' :
               currentStep === 'editor' ? 'Refining analysis...' :
               'Initializing...'}
            </p>
            <Progress
              value={
        ...
        {showResults && analysisResult && (
          <div className="space-y-6 animate-slide-up">
            ...
            {viewMode === 'executive' ? (
              /* Executive View - Clean Summary */
              <Card>
                <CardContent className="pt-6">
                  <div className="grid gap-6 md:grid-cols-2">
                    {/* Strengths */}
                    <div>
                      <h3 className="flex items-center gap-2 font-semibold text-emerald-500 mb-3">
                    ...
                    {/* Weaknesses */}
                    <div>
                      <h3 className="flex items-center gap-2 font-semibold text-red-500 mb-3">
                    ...
                    {/* Opportunities */}
                    <div>
                      <h3 className="flex items-center gap-2 font-semibold text-blue-500 mb-3">
                    ...
                    {/* Threats */}
                    <div>
                      <h3 className="flex items-center gap-2 font-semibold text-yellow-500 mb-3">
                  ...
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    ...
                    Analysis confidence: {Math.round(analysisResult.score * 10)}% - {getScoreBadge(analysisResult.score).label}
                  </div>
                </CardContent>
              </Card>
            ) : (
