  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        {/* Main Tabbed Interface - visible during and after execution */}
        {(isLoading || showResults) && (
          <Tabs value={mainTab} onValueChange={(v) => setMainTab(v as "flow" | "results")}>
            <TabsList className="grid w-full grid-cols-2 max-w-xs mx-auto mb-6">
              <TabsTrigger value="flow" className="gap-1.5">
                <RefreshCw className="h-4 w-4" />
                Flow
              </TabsTrigger>
              <TabsTrigger value="results" className="gap-1.5" disabled={!showResults}>
                <BarChart3 className="h-4 w-4" />
                Results
              </TabsTrigger>
            </TabsList>

            {/* Flow Tab - Process visualization + Activity Log */}
